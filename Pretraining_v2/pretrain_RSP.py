...
def parse_args():
    ...
    parser.add_argument('--gpu', default='0, 1, 2, 3', help='GPU id to use.')
    ...
    # model definition
    parser.add_argument('--model', type=str, default='resnet18', help='choice of network architecture - resnet18.')
    parser.add_argument('--num_classes', type=int, default=6, help='# of classes for resolution sequence prediction.')
    parser.add_argument('--num_epoch', type=int, default=3, help='epochs to train for - 300.')
    parser.add_argument('--batch_size', type=int, default=6, help='batch_size - 512.')
    ...
    # Data paths
    parser.add_argument('--train_image_pth', default='/home/srinidhi/Research/Code/Tiger_Challenge/SSL/Data/',
                        help='path to train images WSIs')
    parser.add_argument('--output_pth', default='/home/srinidhi/Research/Code/Tiger_Challenge/SSL/Data/output/',
                        help='path to save tiles for visualization')
    parser.add_argument('--model_save_pth', type=str,
                        default='/home/srinidhi/Research/Code/Tiger_Challenge/SSL/Save_Results/',
                        help='path to save model')
    parser.add_argument('--save_loss', type=str,
                        default='/home/srinidhi/Research/Code/Tiger_Challenge/SSL/Save_Results/',
                        help='path to save loss')
    parser.add_argument('--resume', default='/home/srinidhi/Research/Code/Tiger_Challenge/SSL/Save_Results/', type=str,
